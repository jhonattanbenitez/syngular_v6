...
exports.preloadFonts = exports.preloadImages = exports.getRandomInteger = exports.calcWinsize = exports.getMousePos = exports.lerp = void 0;
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"js/demo1/galleryItem.js":[function(require,module,exports) {
"use strict";
...
var GalleryItem = /*#__PURE__*/function () {
  function GalleryItem(el) {
    ...
    this.imgRect = this.DOM.img.getBoundingClientRect(); // part of the stack
    ...
    value: function initEvents() {
      ...
      this.onMouseEnterFn = function () {
        ...
        _gsap.gsap.timeline({
          ...
          scale: 0.95
        }).to(_this.DOM.imgInner, {
          scale: 1.2
        }, 0).to(_this.DOM.captionChars, {
          x: function x(pos) {
            return -10 * (Math.floor(_this.captionCharsTotal / 2) - pos);
          },
          stagger: {
            from: 'center'
          }
      ...
      this.onMouseLeaveFn = function () {
        ...
        }).to([_this.DOM.img, _this.DOM.imgInner], {
          scale: 1
        }).to(_this.DOM.captionChars, {
          x: 0
        }, 0);
      };
...
},{"gsap":"../node_modules/gsap/index.js"}],"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
},{}],"js/demo1/galleryController.js":[function(require,module,exports) {
"use strict";
...
(0, _splitting.default)(); // Initialize the Locomotive scroll
...
var GalleryController = /*#__PURE__*/function () {
  function GalleryController(galleryEl) {
    var _this = this;
  ...
  _createClass(GalleryController, [{
    ...
    value: function intro() {
      ...
      var _this$galleryItems$ma = this.galleryItems.map(function (el) {
        return el.DOM.img;
      }),
          _this$galleryItems$ma2 = _toArray(_this$galleryItems$ma),
          firstImage = _this$galleryItems$ma2[0],
          otherImages = _this$galleryItems$ma2.slice(1);

      timeline.addLabel('startAnimation', '+=0') // allow scroll and update the locomotive scroll
      .add(function () {
      ...
      .to(firstImage, {
        ...
        rotation: 0,
        opacity: 1
      }, 'startAnimation') // both the image and inner image animate the scale value to achieve the "reveal effect"
      ...
      try {
        var _loop = function _loop() {
          ...
          timeline.add(function () {
            return item.inStack = false;
          }, 'startAnimation+=1').to(item.DOM.captionChars, {
            duration: 2,
            ease: 'expo',
            startAt: {
              opacity: 0,
              x: function x(pos) {
                return -40 * (Math.floor(item.captionCharsTotal / 2) - pos);
              }
            },
            x: 0,
            opacity: 1,
...
},{"gsap":"../node_modules/gsap/index.js","../utils":"js/utils.js","./galleryItem":"js/demo1/galleryItem.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","splitting":"../node_modules/splitting/dist/splitting.js"}],"js/demo1/index.js":[function(require,module,exports) {
"use strict";
...
var _galleryController = _interopRequireDefault(require("./galleryController"));
...
Promise.all([(0, _utils.preloadImages)('.gallery__item-imginner'), (0, _utils.preloadFonts)('lty4rfv')]).then(function () {
  // Remove loader (loading class)
  document.body.classList.remove('loading'); // Initialize custom cursor

  var cursor = new _cursor.default(document.querySelector('.cursor')); // Initialize the GalleryController

  new _galleryController.default(document.querySelector('.gallery')); // Mouse effects on all links and others

  _toConsumableArray(document.querySelectorAll('a, .gallery__item-img')).forEach(function (link) {
...
},{"../utils":"js/utils.js","../cursor":"js/cursor.js","./galleryController":"js/demo1/galleryController.js"}],"../../../Users/Desarrollo/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../Users/Desarrollo/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/demo1/index.js"], null)
//# sourceMappingURL=/js/proyectos/demo1.151408fb.js.map